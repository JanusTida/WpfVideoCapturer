    ...
    public partial class MainWindow : MetroWindow {
        ...
        private void IniModels() {
            try {
                ...
                VM.SelectedEntranceType = ConfigState.EtrType;
                VM.SingleType = ConfigState.SingleType;
            }
            catch(Exception ex) {
                EventLogger.Logger.WriteLine("MainWindow初始化模型出错:" + ex.Message);
                CDFCMessageBox.Show(FindResourceString("FailedToAquireDevices"), FindResourceString("Error"), MessageBoxButton.OK);
                this.Close();
            }
        }
        /// <summary>
