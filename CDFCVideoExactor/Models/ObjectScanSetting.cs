...
namespace CDFCVideoExactor.Models
{
    ...
    public partial class ObjectScanSetting : NotificationObject
    {
        ...
        public ObjectScanSetting(IObjectDevice iObjectDevice, EntranceType entranceType,DeviceTypeEnum deviceType = DeviceTypeEnum.Unknown)
        {
            ...
            try
            {
                endSector = iObjectDevice.Size / iObjectDevice.SectorSize;
                maxSector = endSector;
    ...
    public partial class ObjectScanSetting
    {
        ...
        //自动设定可用类型;
        private void AutoSetEnabled() {
            if (entranceType == EntranceType.Capturer || entranceType == EntranceType.CapturerSingle) {
                DealWithCapturer();
            }
        ...
        private void DealWithCapturer() {
            ...
            if (SelectedVersionType.DeviceType == DeviceTypeEnum.HaiShiTai ||
                ...
                || SelectedDeviceType.DeviceTypeEnum == DeviceTypeEnum.YinTan
                || SelectedDeviceType.DeviceTypeEnum == DeviceTypeEnum.QiDun
                || SelectedDeviceType.DeviceTypeEnum == DeviceTypeEnum.XiaoMi) {
        ...
        public VersionType SelectedVersionType {
            ...
            set {
                ...
                Action dealWithCp = () => {
                    ...
                    else if (FindResourceString("DaHuaDHFS") == selectedVersionType.Info || FindResourceString("DaHuaNVR") == selectedVersionType.Info) {
                        ScanMethodsEnabled = true;
                        IsMP4ScanEnabled = false;
                        IsLeftScanEnabled = false;
                        ScanMethod = ScanMethod.EntireDisk;
    ...
    public partial class ObjectScanSetting {
                            ...
                            switch (multiMediaType) {
                                ...
                                case MultiMediaType.DrivingRecorder:
                                    ...
                                    deviceTypes = new ObservableCollection<DeviceType>() {
                                        ...
                                        new DeviceType {ID = 4, DeviceTypeEnum = DeviceTypeEnum.WJCL},
                                        new DeviceType {ID = 5, DeviceTypeEnum = DeviceTypeEnum.Unknown }
                                    };
                                    break;
                                #endregion
        ...
        private static VersionType[][] CpVersionTypes = new VersionType[][]{
            ...
            new VersionType[]{
                new VersionType (DeviceTypeEnum.DaHua){ID = 1,Info = FindResourceString("DaHuaDHFS")},
                //new VersionType {ID = 2,Info= "大华DVR2"},
                new VersionType (DeviceTypeEnum.DaHua){ID = 16,Info=FindResourceString("DaHuaNVR")}
            },
            new VersionType[] {
            ...
            new VersionType[] {
                new VersionType (DeviceTypeEnum.HaiShiTai){ID=1,Info=FindResourceString("HaiShiTai") }//海视泰
            },
            new VersionType[] {
                new VersionType (DeviceTypeEnum.RuiShi){ID=1,Info="FAT32 MP4" }//锐视;
            },
            new VersionType[] {
                new VersionType(DeviceTypeEnum.ChuangZe) {ID = 1,Info=FindResourceString("ChuangZe") }
            },
            new VersionType[] {
                new VersionType(DeviceTypeEnum.YinTan){ID = 1,Info=FindResourceString("YinTan")}
            },
            new VersionType[] {
                new VersionType(DeviceTypeEnum.QiDun){ID = 1,Info = FindResourceString("QiDun")}
            },
            new VersionType[] {
                new VersionType(DeviceTypeEnum.XiaoMi){ID = 1,Info=FindResourceString("XiaoMi")}
            }
#endregion
        };
        private static VersionType[] UnknownVersions = new VersionType[] {
            new VersionType (DeviceTypeEnum.Unknown) {ID=0,Info=FindResourceString("UnKnownVersionType"),IsMp4Class = false }
        };
        ...
        private static VersionType[][] DrivingVersionTypes = new VersionType[][] {
            ...
            new VersionType[] {
                                        ...
                                        new VersionType[] {
                                            new VersionType(DeviceTypeEnum.WJCL) {ID = 1,Info = "AVI" } //为佳长凌;
                                        }
            #endregion
        };
        private static VersionType[][] FRecorderVersionTypes = new VersionType[][] {
            ...
            new VersionType[] {
                ...
                //},
                new VersionType[] {
                    new VersionType(DeviceTypeEnum.Unknown) {ID = 0,Info=FindResourceString("UnKnownVersionType") }
                }
            #endregion
        };
        ...
        #region 
            ...
            (cpAndMDeviceTypes = new ObservableCollection<DeviceType> {
                ...
                new DeviceType {ID = 19,  DeviceTypeEnum = DeviceTypeEnum.WJCL },
                new DeviceType {ID = 20,  DeviceTypeEnum = DeviceTypeEnum.XingJi},
                new DeviceType {ID = 21,  DeviceTypeEnum = DeviceTypeEnum.JingYi},
                new DeviceType {ID = 22,  DeviceTypeEnum = DeviceTypeEnum.Unknown }
        ...
        #region
            ...
            (cpDeviceTypes = new ObservableCollection<DeviceType> {
                ...
                new DeviceType {ID = 11, DeviceTypeEnum = DeviceTypeEnum.ChuangZe},
                new DeviceType{ID = 12,DeviceTypeEnum = DeviceTypeEnum.YinTan},
                new DeviceType{ID = 13,DeviceTypeEnum = DeviceTypeEnum.QiDun},
                new DeviceType{ID = 14,DeviceTypeEnum = DeviceTypeEnum.XiaoMi},
                new DeviceType {ID = 15, DeviceTypeEnum = DeviceTypeEnum.Unknown}
            });
        #endregion
        private static ObservableCollection<DeviceType> cpDeviceTypes;
                        ...
                        case EntranceType.MultiMedia:
                            switch (multiMediaType)
                            {
                                ...
                                case MultiMediaType.DrivingRecorder:
                                    ...
                                    dranyVersionList.AddRange(DrivingVersionTypes);
                                ...
                                case MultiMediaType.ForensicRecorder:
                                    ...
                                    franyVersionList.AddRange(FRecorderVersionTypes);
