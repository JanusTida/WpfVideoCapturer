...
//                FilterItems();
        ...
        public bool IsChannelFilterEnabled {
            get {
                ...
                else if(mainWindowViewModel.SelectedEntranceType == Enums.EntranceType.Capturer) {
                    return true;
                }
                else if(mainWindowViewModel.SelectedEntranceType == Enums.EntranceType.CPAndMultiMedia) {
                    return mainWindowViewModel.Scanner?.DeviceType.GetDeviceCategory() == DeviceCategory.Capturer ? true : false;
                }
                return false;
            }
        }
