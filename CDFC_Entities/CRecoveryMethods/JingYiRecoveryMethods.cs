...
namespace CDFCEntities.CRecoveryMethods {
    public class JingYiRecoveryMethods : IRecoveryMethods {
        private static JingYiRecoveryMethods staticInstance;
        public static JingYiRecoveryMethods StaticInstance {
            get {
                return staticInstance ??
                    (staticInstance = new JingYiRecoveryMethods());
            }
        }
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_jingyi_set_preview")]
        private extern static void cdfc_object_set_preview(ulong nSize);

        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_jingyi_filesave")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_jingyi_filesave_f")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_jingyi_readbuffer")]
