...
namespace CDFCEntities.CRecoveryMethods {
    ...
    /// 安联恢复文件所需方法;
    /// </summary>
    public class HaiSiRecoveryMethods : IRecoveryMethods {
        private static HaiSiRecoveryMethods staticInstance;
        public static HaiSiRecoveryMethods StaticInstance {
            get {
                return staticInstance ??
                    (staticInstance = new HaiSiRecoveryMethods());
            }
        }
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_haisi_set_preview")]
        private extern static void cdfc_object_set_preview(ulong nSize);

        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_haisi_filesave")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_haisi_filesave_f")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_canon_readbuffer")]
