...
namespace CDFCEntities.CRecoveryMethods {
    ...
    /// 安联恢复文件所需方法;
    /// </summary>
    public class HanBangRecoveryMethods : IRecoveryMethods {
        private static HanBangRecoveryMethods staticInstance;
        public static HanBangRecoveryMethods StaticInstance {
            get {
                return staticInstance ??
                    (staticInstance = new HanBangRecoveryMethods());
            }
        }
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_hangbang_set_preview")]
        private extern static void cdfc_object_set_preview(ulong nSize);

        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_hangbang_filesave")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_hangbang_filesave_f")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_hangbang_readbuffer")]
