...
{
    public partial class ShanLingRecoveryMethods : IRecoveryMethods
    {
    ...
    public partial class ShanLingRecoveryMethods
    {
        private static ShanLingRecoveryMethods staticInstance;
        public static ShanLingRecoveryMethods StaticInstance {
            get {
                return staticInstance ??
                    (staticInstance = new ShanLingRecoveryMethods());
            }
        }
    }
    public partial class ShanLingRecoveryMethods : IRecoveryMethods
    {
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_shanling_filesave")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_shanling_filesave_f")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_shanling_readbuffer")]
