...
namespace CDFCEntities.CRecoveryMethods {
    public class SonyRecoveryMethods : IRecoveryMethods {
        private static SonyRecoveryMethods staticInstance;
        public static SonyRecoveryMethods StaticInstance {
            get {
                return staticInstance ??
                    (staticInstance = new SonyRecoveryMethods());
            }
        }
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_sony_set_preview")]
        private extern static void cdfc_object_set_preview(ulong nSize);

        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_sony_filesave")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_sony_filesave_f")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_sony_readbuffer")]
