...
namespace CDFCEntities.CRecoveryMethods {
    ...
    /// 佳能恢复文件所需方法;
    /// </summary>
    public partial class CanonRecoveryMethods : IRecoveryMethods {
    ...
    public partial class CanonRecoveryMethods : IRecoveryMethods {
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_canon_filesave")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_canon_filesave_f")]
        ...
        [DllImport("cdfcproject.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_canon_set_preview")]
    ...
    public partial class CanonRecoveryMethods {
