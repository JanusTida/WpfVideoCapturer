...
namespace CDFCEntities.CScanMethods {
    ...
    /// 安联锐士所需要的方法;
    /// </summary>
    public partial class AnLianScanMethods : IScanMethods {
        /// <summary>
        /// 初始化接口;
        /// </summary>
    ...
    /// 安联所需底层方法;
    /// </summary>
    public partial class AnLianScanMethods {
        private const string DLLEntry = "cdfcproject2.dll";
        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_init")]
        ...
        [HandleProcessCorruptedStateExceptions]
        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_search_start")]
        private extern static IntPtr cdfc_object_search_start(IntPtr handle, int type, IntPtr error);

        [HandleProcessCorruptedStateExceptions]
        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_search_start_f")]
        private extern static IntPtr cdfc_object_search_start_f(IntPtr handle, int type, IntPtr error);

        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_current_sector")]
        private extern static ulong cdfc_object_current_sector();

        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_filelist")]
        private extern static IntPtr cdfc_object_filelist();

        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_exit")]
        private extern static void cdfc_object_exit();

        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_stop")]
        private extern static void cdfc_object_stop();

        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_date_converter")]
        public extern static void cdfc_object_date_converter(ulong date, IntPtr resDate);
        
        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_freetask")]
        private extern static void cdfc_object_freetask(IntPtr stFile);

        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_set_regionsize")]
        private extern static void cdfc_object_set_regionsize(ulong regionSize);

        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_search_start_free")]
        private extern static IntPtr cdfc_object_search_start_free(IntPtr handle, int type, IntPtr error);

        [DllImport(DLLEntry, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, EntryPoint = "cdfc_rsfs_cluster")]
