...
namespace CDFCVideoExactor.Controllers {
    ...
    public partial class ScanningController {
        ...
        public void Start() {
            ...
            #region 判断是否为MOV;
            ////若为非MOV结构的处理
            //if(objectScanSetting.SelectedDeviceTypeEnum != DeviceTypeEnum.Canon) {
            ...
            scanningInfoDialogWindowViewModel.TotalSectorCount = objectScanSetting.EndSector;// iObjectDevice.Size /(ulong)iObjectDevice.SectorSize;
            scanningInfoDialogWindowViewModel.EndDate = null;
            ScanningInfoDialogWindow dialog = new ScanningInfoDialogWindow(this.scanningInfoDialogWindowViewModel);
