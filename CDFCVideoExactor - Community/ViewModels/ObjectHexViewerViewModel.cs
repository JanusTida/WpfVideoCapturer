...
namespace CDFCVideoExactor.ViewModels {
    ...
    public partial class ObjectHexViewerViewModel:ViewModelBase {
        ...
        //最大扇区地址;
        private ulong maximumSector;
        //当前扇区号;
        private ulong nowSector;
        public ulong NowSector {
            get {
                return nowSector;
            }
            set {
        ...
        public void GetIObjectDevice(IObjectDevice iObjectDevice) {
            ...
            this.maximumSector = iObjectDevice.Size / (ulong)iObjectDevice.SectorSize - 1;
        ...
        public void SetSectorRange(ulong iniLba, ulong size) {
            this.iniLba = iniLba;
            maximumSector = size / (ulong)iObjectDevice.SectorSize;
            NowSector = 0;
            EscapePage();
        }
    ...
    public partial class ObjectHexViewerViewModel {
        //初始LBA偏移，用于设定文件起始范围;
        private ulong iniLba;
        
        /// <summary>
        /// 跳转至当前页;
        /// </summary>
        private void EscapePage() {
            StokenString = iObjectDevice.GetSectorHexString(iniLba + (nowSector) * (ulong)iObjectDevice.SectorSize);
        }
